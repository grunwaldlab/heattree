...
```{r echo=FALSE}
heat_tree(example_tree_1, metadata = example_metadata_1, aesthetics = c(tipLabelColor = 'source'), layout = 'circular', width = fig_width, height = fig_height, manualZoomAndPanEnabled = FALSE)
```
...
```{r echo=FALSE}
heat_tree(example_tree_path, width = fig_width, height = fig_height, manualZoomAndPanEnabled = FALSE)
```
...
```{r echo=FALSE}
heat_tree(example_tree_path, metadata = example_metadata, aesthetics = c(tipLabelColor = 'source'), width = fig_width, height = fig_height, manualZoomAndPanEnabled = FALSE)
```
...
```{r echo=FALSE}
heat_tree(example_phylo, layout = 'circular', width = fig_width, height = fig_height, manualZoomAndPanEnabled = FALSE)
```
