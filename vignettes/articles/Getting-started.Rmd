...
```{r echo=FALSE}
heat_tree(bansal_2021_tree, metadata = bansal_2021_metadata, aesthetics = c(tipLabelColor = 'Lifestyle'), width = fig_width, height = fig_height, manualZoomAndPanEnabled = FALSE)
```
...
```{r echo=FALSE}
heat_tree(example_tree_path, metadata = example_metadata, aesthetics = c(tipLabelColor = 'Lifestyle'), width = fig_width, height = fig_height, manualZoomAndPanEnabled = FALSE)
```
...
```{r echo=FALSE}
heat_tree(example_phylo, width = fig_width, height = fig_height, manualZoomAndPanEnabled = FALSE)
```
