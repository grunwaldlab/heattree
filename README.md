...
A wrapper for the javascript
[`heat-tree`](https://www.npmjs.com/package/@grunwaldlab/heat-tree)
package for interactive phylogenetic tree visualization widgets.
...
The package includes example data sets so you can try it out with
...
```
    ...
    ## [1] "/home/fosterz/R/x86_64-pc-linux-gnu-library/4.5/heattree/extdata/example_tree_1.treefile"
...
```
    ...
    ## [1] "/home/fosterz/R/x86_64-pc-linux-gnu-library/4.5/heattree/extdata/example_metadata_1.tsv"
...
Contributions are welcome! Please visit the [GitHub
